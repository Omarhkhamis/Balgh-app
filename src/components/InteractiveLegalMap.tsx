...
export default function InteractiveLegalMap({ selectedCountry, onSelectCountry }: InteractiveLegalMapProps) {
    ...
    const CountryBadge = ({ country, top, left, size = 'md' }: { country: string; top: string; left: string; size?: 'sm' | 'md' | 'lg' }) => {
        const sizeClasses = {
                ...
                >
                    ...
                    <div className="relative z-10 h-full">
                        <div className="relative w-full h-full min-h-[450px]">
                            ...
                            <CountryBadge country="Sweden" top="12%" left="54%" size="md" />
                            <CountryBadge country="UK" top="24%" left="42%" size="md" />
                            <CountryBadge country="Netherlands" top="22%" left="50%" size="sm" />
                            <CountryBadge country="Belgium" top="28%" left="48%" size="sm" />
                            <CountryBadge country="Germany" top="27%" left="53%" size="md" />
                            <CountryBadge country="France" top="36%" left="46%" size="md" />
                            <CountryBadge country="Switzerland" top="39%" left="51%" size="sm" />
                            <CountryBadge country="Austria" top="37%" left="56%" size="sm" />
                            <CountryBadge country="Spain" top="48%" left="42%" size="md" />

                            {/* Middle East */}
                            <CountryBadge country="Turkey" top="42%" left="65%" size="md" />
                            <CountryBadge country="Syria" top="52%" left="68%" size="md" />

                            {/* North America */}
                            <CountryBadge country="Canada" top="20%" left="18%" size="md" />
                            <CountryBadge country="USA" top="40%" left="20%" size="md" />
                        </div>
