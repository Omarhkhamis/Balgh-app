            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-scale-in" dir="rtl">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                        <h4 className="font-bold text-gray-900 mb-3">التصنيف الحالي:</h4>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <span className="text-gray-500">التصنيف:</span>
                                <span className="font-bold text-gray-900 mr-2">{getCategoryLabel(aiClassification)}</span>
                            </div>
                            <div>
                                <span className="text-gray-500">مستوى الخطر:</span>
                                <span className="font-bold text-gray-900 mr-2">{aiRiskLevel}</span>
                            </div>
                            <div className="col-span-2">
                                <span className="text-gray-500">درجة الحدة:</span>
                                <span className="font-bold text-gray-900 mr-2">{severityScore}/10</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition-all ${userCorrection === 'Hate Speech'
                                ...
                                <input
                                    ...
                                    name="correction"
                                    value="Hate Speech"
                                    checked={userCorrection === 'Hate Speech'}
                                    onChange={(e) => setUserCorrection(e.target.value)}
                                    className="w-5 h-5 text-red-600"
                                    disabled={isSubmitting}
                                />
                                <span className="mr-3 font-medium text-gray-900">خطاب كراهية</span>
                            </label>

                            <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition-all ${userCorrection === 'Incitement to Violence'
                                ...
                                <input
                                    ...
                                    checked={userCorrection === 'Incitement to Violence'}
                                    onChange={(e) => setUserCorrection(e.target.value)}
                                    className="w-5 h-5 text-orange-600"
                                    disabled={isSubmitting}
                                />
                                <span className="mr-3 font-medium text-gray-900">تحريض على العنف</span>
                            </label>

                            <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition-all ${userCorrection === 'Safe'
                                ...
                                <input
                                    ...
                                    name="correction"
                                    value="Safe"
                                    checked={userCorrection === 'Safe'}
                                    onChange={(e) => setUserCorrection(e.target.value)}
                                    className="w-5 h-5 text-green-600"
                                    disabled={isSubmitting}
                                />
                                <span className="mr-3 font-medium text-gray-900">محتوى آمن</span>
                            </label>
                        </div>
                    </div>
